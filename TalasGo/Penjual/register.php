                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index.php" class="d-block auth-logo">
                                    <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">TalasGO</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Sudah memiliki akun? <a href="login.php" class="text-primary fw-semibold"> Login </a> </p>
                                </div>
                            </div>
