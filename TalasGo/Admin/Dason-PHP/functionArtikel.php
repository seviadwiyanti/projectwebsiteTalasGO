...
function hapus($id) {
    ...
    // Hapus terlebih dahulu data terkait di tabel tbl_komentar
    mysqli_query($db, "DELETE FROM tbl_komentar WHERE id_artikel = $id");

    // Setelah itu, baru hapus data di tabel tbl_artikel
